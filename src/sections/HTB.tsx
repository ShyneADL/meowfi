...
const HTB = () => {
  return (
    <section id='how-to-buy' className="relative mt-[-25px] flex flex-col items-start htb-bg pb-32 xl:px-[73px] lg:px-10 px-5 pt-[39px] flex-1 w-full z-50 overflex-x-hidden">
